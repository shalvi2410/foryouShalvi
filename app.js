...
// DATA
let yourName = (localStorage.getItem('yourName') != null)? localStorage.getItem('yourName') : 'Shreyansh';
yourNameInput.value = yourName;
let herName = (localStorage.getItem('herName') != null)? localStorage.getItem('herName') : 'Shalvi';
...
function assignData(yourName, herName) {
    data = [
        ...
        },
        {
            ...
            ans         :   ['Shreyansh', 'Shreyansh', 'Shreyansh']
        }
    ]
}
...
function readData(message) {
    ...
    message = (message == false)? "Sunai nahi diya fir se bol" : message;
